...
Product_maas {
    ...
    public Product_maas(String guid, int boxingTemp, Double salesPrice, int breadsPerOven, int breadsPerBox, int itemPrepTime, int doughPrepTime, int bakingTemp, int coolingRate, int bakingTime, int restingTime, Double productionCost) {
        this.guid = guid;
    ...
    public Product_maas(String json_product_string) {
